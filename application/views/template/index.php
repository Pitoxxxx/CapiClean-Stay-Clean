...
<!-- fevicon -->
<link rel="icon" href="<?=base_url('assets/')?>imagess/fevicon.png" type="image/gif" />
  ...
  <!--header section start -->
    <div class="header_section">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <div class="logo"><a href="index.html"><img src="<?=base_url('assets/')?>imagess/logo.png"></a></div>
          </div>
          <div class="col-md-9">
            <div class="menu_text">
              <ul>
                ...
                <span onclick="openNav()"><img src="<?=base_url('assets/')?>imagess/toggle-icon.png" class="toggle_menu"></span>
              </ul>
            </div>      
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-5">
            ...
            <div class="contact_bt"><a href="contact.html">CONTACT US<span class="contact_padding"><img src="<?=base_url('assets/')?>imagess/contact-icon.png"></span></a></div>
          </div>
          <div class="col-sm-2">
            <div class="play_icon"><a href="#"><img src="<?=base_url('assets/')?>imagess/play-icon.png"></a></div>
          </div>
          <div class="col-sm-5">
    ...
    <div class="services_section layout_padding">
      <div class="container">
        <h1 class="services_taital"><span>Our</span> <img src="<?=base_url('assets/')?>imagess/icon-1.png"> <span style="color: #1f1f1f">Services</span></h1>
    ...
    <div class="about_section layout_padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <h1 class="services_taital"><span>About </span> <img src="<?=base_url('assets/')?>imagess/icon-1.png"> <span style="color: #1f1f1f">Cleaning</span></h1>
            <p class="ipsum_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</p>
            <div class="contact_bt_1"><a href="#">READ MORE<span class="contact_padding"><img src="<?=base_url('assets/')?>imagess/contact-icon1.png"></span></a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="choose_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Why </span> <img src="<?=base_url('assets/')?>imagess/icon-1.png"> <span style="color: #1f1f1f">Choose Us</span></h1>
    ...
    <div class="team_section layout_padding">
      <div class="container">
        <h1 class="choose_taital"><span>Our </span> <img src="<?=base_url('assets/')?>imagess/icon-1.png"> <span style="color: #1f1f1f">Team</span></h1>
        <p class="choose_text">Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                ...
                <div class="col-sm-5">
                  ...
                  <div class="follow_social_icon">
                    <ul>
                      ...
                      <li><a href="#"><img src="<?=base_url('assets/')?>imagess/twitter-icon.png"></a></li>
                      <li><a href="#"><img src="<?=base_url('assets/')?>imagess/linkden-icon.png"></a></li>
                      <li><a href="#"><img src="<?=base_url('assets/')?>imagess/instagram-icon.png"></a></li>
                    </ul>
                  </div>
                </div>
                <div class="col-sm-7">
      ...
      <div class="container">
        <div class="footer_main">
          <div class="footer_left">
            <h1 class="contact_taital"><span>Contact </span> <img src="<?=base_url('assets/')?>imagess/icon-2.png"> <span>Us</span></h1>
          </div>
          <div class="footer_left">
            <div class="location_text"><a href="#"><img src="<?=base_url('assets/')?>imagess/map-icon.png"><span class="padding_left_15">Locations</span></a></div>
          </div>
          <div class="footer_left">
            <div class="location_text"><a href="#"><img src="<?=base_url('assets/')?>imagess/call-icon.png"><span class="padding_left_15">+71 9876543210</span></a></div>
          </div>
          <div class="footer_left">
            <div class="location_text"><a href="#"><img src="<?=base_url('assets/')?>imagess/map-icon.png"><span class="padding_left_15">demo@gmail.com</span></a></div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="social_icon">
                <ul>
                  <li><a href="#"><img src="<?=base_url('assets/')?>imagess/fb-icon1.png"></a></li>
                  <li><a href="#"><img src="<?=base_url('assets/')?>imagess/twitter-icon1.png"></a></li>
                  <li><a href="#"><img src="<?=base_url('assets/')?>imagess/linkden-icon1.png"></a></li>
                  <li><a href="#"><img src="<?=base_url('assets/')?>imagess/instagram-icon1.png"></a></li>
                </ul>
              </div>
            </div>
          </div>
