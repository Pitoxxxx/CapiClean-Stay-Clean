...
<head>
	...
	<!-- Favicon icon -->
	<link rel="icon" href="<?php echo base_url(); ?>assets/imagess/icon-1.png" type="logo.png">
	<!-- Google font-->
					...
					<nav class="pcoded-navbar">
						...
						<div class="pcoded-inner-navbar main-menu">
							<div class="">
								...
								<div class="pcoded-navigation-label" data-i18n="nav.category.forms">Menu Utama </div>
								<ul class="pcoded-item pcoded-left-item">
								<li>
										<a href="<?= site_url('Customer/') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon"><i class="ti-user"></i><b>FC</b></span>
											<span class="pcoded-mtext"
												data-i18n="nav.form-components.main">Customer</span>
											&nbsp;
											&nbsp;
											<span class="pcoded-mcaret"></span>
										</a>
									...
									<li>
										<a href="<?= site_url('Karyawan/') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon"><i class="ti-user"></i><b>FC</b></span>
											<span class="pcoded-mtext"
												data-i18n="nav.form-components.main">Karyawan</span>
											&nbsp;
											&nbsp;
											<span class="pcoded-mcaret"></span>
										</a>
									...
									<!-- <li>
										<a href="<?= site_url('Poli/') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon"><i class="ti-agenda"></i><b>FC</b></span>
											<span class="pcoded-mtext" data-i18n="nav.form-components.main">Poli</span>
											&nbsp;
											&nbsp;
											<span class="pcoded-mcaret"></span>
										</a>
									...
									<!-- Counter - Messages -->
									<!-- <li>
										<a href="<?= site_url('Feedback/') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon"><i class="ti-pencil-alt"></i><b>FC</b></span>
											<span class="pcoded-mtext"
												data-i18n="nav.form-components.main">Feedback</span>
											&nbsp;
											&nbsp;
											&nbsp;
											&nbsp;
											...
											&nbsp;
											&nbsp;
											<span class="badge badge-danger badge-counter"><?= $jlh ?></span>
											<span class="pcoded-mcaret"></span>
										</a>
									</li> -->
									<?php 
									...
									<li>
										<a href="<?= site_url('Profil/') ?>" class="waves-effect waves-dark">
									...
									<li>
										<a href="<?= site_url('Profil/dokter_user') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon"><i class="ti-support"></i><b>FC</b></span>
											<span class="pcoded-mtext"
												data-i18n="nav.form-components.main">Dokter</span>
											<span class="pcoded-mcaret"></span>
										</a>
									</li>

									<li>
										<a href="<?= site_url('Profil/poli_user') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon"><i class="ti-agenda"></i><b>FC</b></span>
											<span class="pcoded-mtext" data-i18n="nav.form-components.main">Poli</span>
											<span class="pcoded-mcaret"></span>
										</a>
									...
									<li>
										<a href="<?= site_url('Profil/tambah_feedback') ?>"
